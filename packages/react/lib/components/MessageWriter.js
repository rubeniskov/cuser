...
import usePublishMessage from '../hooks/usePublishMessage'; // Components
...
export const MessageWriter = ({
  ...
  const [publishMessage, publisher] = usePublishMessage({
    topicId
  });
  const {
    data: {
  ...
  const handleKeyDown = useCallback(evt => evt.which === 13 && publishMessage({
    content: value,
    accessToken
  }), [accessToken, value]);
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [error && /*#__PURE__*/_jsx("pre", {
    ...
    }), accessToken ? /*#__PURE__*/_jsxs("div", {
      children: [/*#__PURE__*/_jsxs(ListItem, {
        ...
        children: [/*#__PURE__*/_jsx("input", {
          ...
          children: [!loading && /*#__PURE__*/_jsxs("svg", {
