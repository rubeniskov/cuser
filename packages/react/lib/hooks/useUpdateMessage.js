...
var useUpdateMessage = function useUpdateMessage(opts) {
  ...
  var resolver = (0, _react.useCallback)(function (_ref) {
    ...
    return client.updateMessage(topicId, accessToken, messageId, content);
  }, [client]);
  ...
  var updateMessage = (0, _react.useCallback)(function (messageId, content) {
