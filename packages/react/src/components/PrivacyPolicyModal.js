...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Cuser.
...
- __Website__ refers to Cuser, accessible from http://www.mysite.com
...
By visiting this page on our website: http://www.mycompany.com/contact
`
const PrivacyPolicyModal = ({ onClose, className, open }) => {
  return open ? createPortal(
    <div className={className} onClick={onClose}>
      <div className="backdrop">
        <div className="modal">
          <div className={'content'}>
            <MarkdownPreview>{privacyPolicyText}</MarkdownPreview>
          </div>
...
export default styled(PrivacyPolicyModal)`
  position: fixed;
  z-index: 999;
  top: 0;
  left: 0;
