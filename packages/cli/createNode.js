...
// https://github.com/ipfs/js-ipfs/blob/master/examples/browser-exchange-files/test.js
// https://github.com/libp2p/js-libp2p/blob/master/examples/libp2p-in-the-browser/index.js
// https://github.com/libp2p/js-libp2p/blob/master/doc/CONFIGURATION.md#customizing-transports
  ...
  return new Libp2p({
    ...
    addresses: {
      listen: [
        ...
        '/ip4/127.0.0.1/tcp/4004/wss',
        // '/dns4/your-wrtc-star.pub/tcp/443/wss/p2p-webrtc-star'
        // '/ip4/127.0.0.1/tcp/4005/ws/p2p-webrtc-star'
      ]
    },
    ...
    config: {
      transport: {
        ...
        [Websockets.prototype[Symbol.toStringTag]]: {
          filter: (what) => console.log(what)||true
        }
      },
      peerDiscovery: {
...
module.exports = (opts) => IPFS.create({
  ...opts,
  // libp2p: libp2pBundle,
  config: {
    Addresses: {
