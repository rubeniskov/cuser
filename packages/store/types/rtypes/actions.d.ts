...
export const TYPE_ACTION_DELETE_MESSAGE: string;
export const TYPE_ACTION_SEAL: string;
export const TYPE_ACTION_REHYDRATE: string;
export const TYPE_ACTION_RESOLVED: string;
